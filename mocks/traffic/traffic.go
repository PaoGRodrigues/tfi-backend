...
func (m *MockTrafficUseCase) GetActiveFlows() []traffic.TrafficFlow {
	m.ctrl.T.Helper()
...
func (m *MockTrafficUseCase) GetTrafficFlows() ([]traffic.TrafficFlow, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTrafficUseCaseMockRecorder) GetTrafficFlows() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTrafficFlows", reflect.TypeOf((*MockTrafficUseCase)(nil).GetTrafficFlows))
}
...
func (m *MockTrafficRepository) GetClients() ([]traffic.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockTrafficRepository) GetFlowByKey(arg0 string) (traffic.TrafficFlow, error) {
	m.ctrl.T.Helper()
...
func (m *MockTrafficRepository) GetServerByAttr(arg0 string) (traffic.Server, error) {
	m.ctrl.T.Helper()
...
func (m *MockTrafficRepository) GetServers() ([]traffic.Server, error) {
	m.ctrl.T.Helper()
...
// StoreFlows mocks base method.
func (m *MockTrafficRepository) StoreFlows(arg0 []traffic.TrafficFlow) error {
	m.ctrl.T.Helper()
...
func (m *MockTrafficService) GetAllActiveTraffic() ([]traffic.TrafficFlow, error) {
	m.ctrl.T.Helper()
