...
func (m *MockAlertUseCase) GetAllAlerts() ([]alert.Alert, error) {
	m.ctrl.T.Helper()
...
func (m *MockAlertUseCase) GetAllAlertsByTime(arg0, arg1 int) ([]alert.Alert, error) {
	m.ctrl.T.Helper()
...
// GetAllAlerts mocks base method.
func (m *MockAlertService) GetAllAlerts(arg0, arg1 int) ([]alert.Alert, error) {
	m.ctrl.T.Helper()
